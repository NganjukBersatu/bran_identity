      ...
      <div class="container intro-container">
        ...
        <div class="intro-right reveal reveal--up" style="--reveal-delay: 120ms">
          ...
          <div class="intro-links">
            <a href="#artikel" class="intro-link primary-link">
              Jelajahi artikel
              <span>↗</span>
            </a>

            <a href="#featured" class="intro-link">
              Artikel pilihan
              <span>↓</span>
            </a>
          </div>
      ...
      <div class="container">
        ...
        <div class="cta-card reveal reveal--scale">
          ...
          <div class="cta-content">
            ...
            <p>
              Diskusikan kebutuhan software bisnis Anda
              bersama tim kami.
            </p>
...
.info-highlight {
  background: rgba(252, 239, 146, .18);
}
